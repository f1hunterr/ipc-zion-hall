...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 sm:bottom-5 sm:right-5 z-30 w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-lg hover:bg-[#1ebe5d] transition-colors"
    >
